...
import { hexLayerVariants } from '@/lib/animations/cardAnimations';
...
export function HexIcon({
  ...
  return (
    ...
    >
      ...
      <defs>
        <clipPath id={clipId}>
          <rect x="0" y="-24" width="123" height="184" fill="white" />
        </clipPath>
      </defs>
    </svg>
  );
